INSERT INTO services (title, icon_class, description) VALUES
('Web Development', 'fas fa-code', 'Pengembangan website modern dan responsif menggunakan teknologi terkini untuk memenuhi kebutuhan bisnis Anda.'),
('Mobile App Development', 'fas fa-mobile-alt', 'Pembuatan aplikasi mobile yang user-friendly dan berkualitas tinggi untuk platform Android dan iOS.'),
...
('Sarah Johnson', 'UI/UX Designer', 'Designer berpengalaman dengan keahlian dalam menciptakan interface yang menarik dan user experience yang optimal.'),
('Michael Chen', 'Project Manager', 'Project Manager bersertifikat dengan track record mengelola proyek teknologi dari konsep hingga implementasi yang sukses.');

INSERT INTO company_profile (contact_email, description)
VALUES ('hbr@yopmail.com', 'HyperBolt adalah tim pengembang digital yang menghadirkan solusi teknologi dengan kecepatan dan presisi. Dari startup hingga enterprise, kami membantu bisnis berkembang melalui web, mobile, dan integrasi sistem.');
